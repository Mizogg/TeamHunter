...
INFO_FOUND = "found/found_info.txt"
...
def winner_save(words, account_extended_private_key, account_extended_public_key, balance_initial, totalReceived_initial, totalSent_initial, txs_initial):
    with open(WINNER_FOUND, 'a') as file:
...
def found_save_bal(path, caddr, balance_derivationc, totalReceived_derivationc, totalSent_derivationc, txs_derivationc, uaddr, balance_derivationu, totalReceived_derivationu, totalSent_derivationu, txs_derivationu, words, private_key, root_public_key, extended_private_key, root_extended_private_key, compressed_public_key, uncompressed_public_key, wif_private_key, wif_compressed_private_key):
    with open(INFO_FOUND, 'a') as file:
...
class GUIInstance(QMainWindow):
    ...
    def initUI(self):
        ...
        line1_label.setStyleSheet("font-size: 18px; font-weight: bold;")
        ...
        div_label.setStyleSheet("font-size: 10pt; font-weight: bold;")
        ...
        enter_button.enterEvent = lambda e: Speaker.playsound(Speaker.obj(Speaker.menu_focus)) if config.get("sound_enabled", True) else None
        ...
        welcome_label1.setStyleSheet("font-size: 18px; font-weight: bold;")
        ...
        div_label1.setStyleSheet("font-size: 10pt; font-weight: bold;")
        ...
        forward_button.enterEvent = lambda e: Speaker.playsound(Speaker.obj(Speaker.menu_focus)) if config.get("sound_enabled", True) else None
        forward_button.setFixedWidth(200)
        ...
        random_button.enterEvent = lambda e: Speaker.playsound(Speaker.obj(Speaker.menu_focus)) if config.get("sound_enabled", True) else None
        random_button.setFixedWidth(200)
        ...
        self.load_mode_button.setStyleSheet("font-size: 10pt;")
