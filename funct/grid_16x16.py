...
class GridFrame(QMainWindow):
    def __init__(self):
        ...
        #self.setGeometry(30, 30, 1600, 600)
        self.move(30, 30)
    ...
    def init_ui(self):
        ...
        self.colorComboBox.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> 6 Colour Options Available pick your Favourite </span>')
        ...
        self.edt_seed_ratio.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> The ammount of On or Off squares in the grid as a percentage </span>')
        seed_layout.addWidget(self.edt_seed_ratio)
        self.btn_seed = QPushButton('Seed', self)
        self.btn_seed.clicked.connect(self.seed)
        self.btn_seed.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Single Random Seed % </span>')
        ...
        self.inverse_button.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Inverse squares on grid </span>')
        ...
        self.btn_clear.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Clear the Grid </span>')
        self.btn_clear.clicked.connect(self.clear_canvas)
        seed_layout.addWidget(self.btn_clear)
        self.btn_start_stop = QPushButton('Start Random Scan')
        self.btn_start_stop.setStyleSheet("color: green")
        self.btn_start_stop.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Start Random Scan from Seed % (Must Click the Seed Button First) Click again to stop </span>')
        ...
        for col in range(GRID_SIZE):
            ...
            vertical_checkbox_layout.addSpacing(3)
        self.clear_cols_checkbox = QPushButton("Clear")
        self.clear_cols_checkbox.setStyleSheet("color: blue")
        self.clear_cols_checkbox.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Clear Columns Checked Boxes </span>')
        ...
        self.clear_rows_checkbox.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Clear Rows Checked Boxes </span>')
        ...
        labels_starting.addWidget(self.mute_mode_button)
        ...
        self.pattern_dropdown.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Game of Life Patterns </span>')
        ...
        self.btn_game_of_life.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Start Selected Game of Life Patterns Click again to stop </span>')
        ...
        self.num_random_matrix.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Ammount Of Random Martix Particals Show on Grid </span>')
        ...
        self.num_drops_selector.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Ammount Of Rain Drops shown on Grid </span>')
        ...
        self.num_Smoke_ups_selector.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Ammount Of Smoke Particals shown on Grid </span>')
        ...
        self.num_Lava_bubbles_selector.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Ammount Of LavaBubbles shown on Grid </span>')
        ...
        self.num_block_selector.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Lenght of Blocks shown on Grid </span>')
        ...
        forward_layout.addWidget(self.forward_scaning)
        self.start_button_forward = QPushButton('Start Forward', self)
        self.start_button_forward.setStyleSheet("color: green")
        self.start_button_forward.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Scan Forward from your starting HEX. Choose the amount to jump/stride </span>')
        self.start_button_forward.clicked.connect(self.start_stop_jump_forward)
        forward_layout.addWidget(self.start_button_forward)
        ...
        start_button_backward.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Scan Backwards from your starting HEX. Choose the amount to jump/stride </span>')
        ...
        self.keyspaceLineEdit = QLineEdit("40000000000000000:7FFFFFFFFFFFFFFFF", self)
        self.keyspaceLineEdit.setPlaceholderText('Example range for 67 = 40000000000000000:7FFFFFFFFFFFFFFFF')
        ...
        self.btn_start_keyspace.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Start keyspace Scanning Random within your keyspaceRange </span>')
        ...
        self.keyspace_slider.setValue(67)
        self.slider_value_display = QLabel(self)
        self.slider_value_display.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Drag Left to Right to Adjust Range </span>')
        ...
        self._txt_inputhex.setText('deaddeaddeaddeaddeaddeaddeaddead')
        self._txt_inputhex.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Type in Here your own HEX to Visualize </span>')
        self._txt_inputhex.setFocus()
        keyspaceLayout2.addWidget(self._txt_inputhex)
        self._btc_bin = QPushButton("Start Visualize", self)
        self._btc_bin.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Visualize Your Own Private key in HEX </span>')
        ...
        self.brain_input.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Type in Here your own Brainwords or Mnemonic words separated with a space </span>')
        ...
        self.enter_button.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Check Brain Wallet Words from Input box and display on GRID </span>')
        ...
        self.enter_button1.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Check Mnemonic Words from Input box and display on GRID </span>')
        ...
        self.forever_button.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Random Generation of mnemonic words. Pick your ammount of words to be generated and also Language. These can be set to a Random ammount and or Random Languages </span>')
        ...
        self.ammount_words.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Ammount of Words for Random Generation </span>')
        ...
        self.lang_words.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> Pick Language for Random Generation </span>')
        ...
        self.derivation_choice.setToolTip('<span style="font-size: 10pt; font-weight: bold; color: black;"> “derivation path.” Simply put, a derivation path defines a consistent method for generating the same set of accounts and wallets for a given private key </span>')
        ...
        address_layout_caddr = QVBoxLayout()
        ...
        address_layout_caddr.addLayout(balance_transactions_layout)
        address_layout_caddr.addLayout(received_sent_layout)
        
        address_layout_uaddr = QVBoxLayout()
        ...
        balanceu_transactions_layout = QHBoxLayout()
        balanceu_label = QLabel('Balance:')
        self.balanceu_label_edit = QLineEdit()
        self.balanceu_label_edit.setReadOnly(True)
        balanceu_transactions_layout.addWidget(balanceu_label)
        balanceu_transactions_layout.addWidget(self.balanceu_label_edit)

        transactionsu_label = QLabel('Transactions:')
        self.transactionsu_label_edit = QLineEdit()
        self.transactionsu_label_edit.setReadOnly(True)
        balanceu_transactions_layout.addWidget(transactionsu_label)
        balanceu_transactions_layout.addWidget(self.transactionsu_label_edit)
        
        receivedu_sent_layout = QHBoxLayout()
        totalReceivedu_label = QLabel('TotalReceived:')
        self.totalReceivedu_label_edit = QLineEdit()
        self.totalReceivedu_label_edit.setReadOnly(True)
        receivedu_sent_layout.addWidget(totalReceivedu_label)
        receivedu_sent_layout.addWidget(self.totalReceivedu_label_edit)

        totalSentu_label = QLabel('TotalSent:')
        self.totalSentu_label_edit = QLineEdit()
        self.totalSentu_label_edit.setReadOnly(True)
        receivedu_sent_layout.addWidget(totalSentu_label)
        receivedu_sent_layout.addWidget(self.totalSentu_label_edit)
        address_layout_uaddr.addWidget(open_button)
        address_layout_uaddr.addLayout(balanceu_transactions_layout)
        address_layout_uaddr.addLayout(receivedu_sent_layout)

        address_layout_p2sh = QVBoxLayout()
        ...
        address_layout_bc1 = QVBoxLayout()
    ...
    def on_btc_hunter_finished_online(self, data, returncode):
        if returncode == 'scanning':
            ...
            self.btc_address_editp2sh.setText('')
            self.btc_address_editbc1.setText('')
            self.balanceu_label_edit.setText(data.split("\n")[4].split(":")[1].strip())
            self.transactionsu_label_edit.setText(data.split("\n")[7].split(":")[1].strip())
            self.totalReceivedu_label_edit.setText(data.split("\n")[5].split(":")[1].strip())
            self.totalSentu_label_edit.setText(data.split("\n")[6].split(":")[1].strip())
            self.tick_count += 0.5
            self.addr_count += 1
            self.update_labels()
        elif returncode == 'winner':
    ...
    def Smoke_ups(self):
        ...
        for _ in range(num_new_Smoke_ups):
            ...
            self.matrix_drops.append(utils.Smoke_up(row, col, self.rows))
    ...
    def Lava_bubbles(self):
        ...
        for _ in range(num_new_Lava_bubbles):
            ...
            col = random.randint(0, self.cols - 1)
            self.matrix_bubbles.append(utils.LavaBubble(row, col, self.rows))
    ...
    def blocks_run(self):
        ...
        row = random.randint(0, self.rows // 2)
        col = random.randint(0, self.cols - 1)
        self.blocks_work.append(utils.blocking_grid(row, col, self.rows))
    ...
    def matrix_rain(self):
        ...
        for _ in range(num_new_drops):
            if random.random() < 0.1:
                col = random.randint(0, self.cols - 1)
                self.matrix_drops.append(utils.MatrixDrop(col, self.rows))
