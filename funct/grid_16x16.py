...
class GridFrame(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.keyspaceLineEdit = QLineEdit("80000000000000000:FFFFFFFFFFFFFFFFF", self)
        self.keyspaceLineEdit.setPlaceholderText('Example range for 68 = 80000000000000000:FFFFFFFFFFFFFFFFF')
