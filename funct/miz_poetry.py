...
class GUIInstance(QMainWindow):
    ...
    def initUI(self):
        ...
        start_button_ice.enterEvent = lambda e: Speaker.playsound(Speaker.obj(Speaker.menu_focus)) if config.get("sound_enabled", True) else None
        ...
        self.start_edit = QLineEdit("147573952589676412928")
        ...
        self.end_edit = QLineEdit("295147905179352825855")
