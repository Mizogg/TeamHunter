...
class GUIInstance(QMainWindow):
    ...
    def initUI(self):
        ...
        if not save_start:
            save_start = '40000000000000000'

        if not save_end:
            save_end = '7FFFFFFFFFFFFFFFF'
