...
from funct import (set_settings, create_setting, range_div_gui, about_gui, ice_gui, bitcrack_gui, keyhunt_gui, grid_16x16, miz_mnemonic, miz_poetry, conversion_gui, balance_gui, brain_gui, xpub_gui, calculator, vanbit_gui)
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        dark_label = QLabel("EXTRA TOOLS (16x16 Grid, Tetris, Range Division, Conversion, Balance, Mute/UnMute)")
