...
class GUIInstance(QMainWindow):
    ...
    def initUI(self):
        ...
        lang_words_label.setStyleSheet("font-size: 10pt; font-weight: bold; color: #E7481F;")
        ...
        div_label.setStyleSheet("font-size: 10pt; font-weight: bold; color: #E7481F;")
        ...
        div_label1.setStyleSheet("font-size: 10pt; font-weight: bold; color: #E7481F;")
        ...
        self.load_mode_button.setStyleSheet(
                "QPushButton { font-size: 10pt; background-color: #E7481F; color: white; }"
                "QPushButton:hover { font-size: 10pt10pt; background-color: #A13316; color: white; }"
            )
