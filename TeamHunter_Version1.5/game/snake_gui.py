...
class StartScreen(QWidget):
    ...
    def initUI(self):
        ...
        combined_text = """
        <html><center>
        <font size="10" color="#E7481F">🐍 Snake Game 🐍</font>
        ...
        <br><br><font size="3">
        Image Good food: <img src="images/main/btc.png" width="30" height="30">
        <br><br>
        Image Bad food: <img src="images/main/bad.png" width="30" height="30">
        <br><br>
        <img src="images/main/head.png" width="30" height="30">
        <img src="images/main/body.png" width="30" height="30">
        <img src="images/main/body.png" width="30" height="30">
        <img src="images/main/body.png" width="30" height="30">
        <img src="images/main/body.png" width="30" height="30">
        <img src="images/main/body.png" width="30" height="30">
