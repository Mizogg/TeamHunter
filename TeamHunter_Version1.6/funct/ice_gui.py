...
class GUIInstance(QMainWindow):
    ...
    def initUI(self):
        ...
        power_label.setStyleSheet("font-size: 12pt; font-weight: bold;")
        ...
        crypto_label.setStyleSheet("font-size: 12pt; font-weight: bold;")
        ...
        if not save_start:
            save_start = '80000000000000000'

        if not save_end:
            save_end = 'FFFFFFFFFFFFFFFFF'
